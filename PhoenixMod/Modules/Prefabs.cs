...
namespace PhoenixWright.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = PhoenixPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = PhoenixPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = PhoenixPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = PhoenixPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            PhoenixPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            PhoenixPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            PhoenixPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
